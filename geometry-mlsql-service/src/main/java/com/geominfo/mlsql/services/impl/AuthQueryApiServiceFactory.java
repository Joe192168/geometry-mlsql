...
@Slf4j
@Component
public class AuthQueryApiServiceFactory implements FallbackFactory<AuthQueryApiService> {
    @Override
    public AuthQueryApiService create(Throwable throwable) {
        return new AuthQueryApiService() {
            @Override
