...
public class SystemCustomIdentification {
    ...
    //返回成功的返回码值
    public static final Integer CODE_VAL = 200;
    ...
    //token存储redis文件夹
    public static final String TOKEN_FOLDER = "token:";

    //前端参数存储redis文件夹
    public static final String PARAM_FOLDER = "param:";

    //前端时间存储redis文件夹
    public static final String TIME_FOLDER = "time:";

    //未读消息标识
    public static final String UNREAD_MESSAGE = "0";

    //已读消息标识
    public static final String READ_MESSAGE = "1";

    //已删除消息标识
    public static final String DELETE_MESSAGE = "2";
