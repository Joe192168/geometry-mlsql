...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "geometryHaHaHaHa";
     ...
     */
    public static String ssoEncrypt(String str, String key) throws Exception {
     ...
     */
    public static String ssoDecrypt(String str, String key) throws Exception {
        if (str == null || key == null) return null;
        Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
    ...
    public static void main(String[] args) {
        System.out.println(aesEncode("aaa", "8sug5m86xhrclyfo"));
        System.exit(0);
